...
Requires:	gnome-games-extra-data-glines >= 2.12.1
Requires:	gnome-games-extra-data-gnobots2 >= 2.12.1
Requires:	gnome-games-extra-data-gnometris >= 2.12.1
Requires:	gnome-games-extra-data-iagno >= 2.12.1
Requires:	gnome-games-extra-data-mahjongg >= 2.12.1
Requires:	gnome-games-extra-data-same-gnome >= 2.12.1
