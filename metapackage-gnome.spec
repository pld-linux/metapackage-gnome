...
Requires:	gnome-themes-extras-Darklooks >= 2.20.0
Requires:	gnome-themes-extras-Foxtrot >= 2.20.0
Requires:	gnome-themes-extras-Gion >= 2.20.0
Requires:	gnome-themes-extras-Neu >= 2.20.0
